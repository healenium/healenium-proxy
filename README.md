...
### Overall information
Healenium-Proxy - it's platform agnostic solution. Therefore, no matter which language you use, it will heal selenium-based test cases at the level of selenium server. 
This approach involves running a standalone proxy server that sits between the test runner (Selenium server) and the web application being tested. 
Healenium-Proxy able to use all Selenium supported languages Java/Python/JS/C# and frameworks. 
Client have to create RemoteWebDriver and connect to Healenium-Proxy instance. That will be described in more detail later.
